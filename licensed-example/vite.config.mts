// Build config for the licensed-example runtime frontend bundle
// (frontend/frontend.mjs). Lib mode, everything inlined (React included) —
// see docs/plugins.md "Runtime frontends (frontend.mjs)". Served from
// /plugins-assets/<name>/.
//
